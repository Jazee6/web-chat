/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 392ede0ecdc8099def2d8d8e54f5d2df)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "EASY_AUTH_CLIENT_ID" | "EASY_AUTH_CLIENT_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN">> {}
}
...
interface Ai_Cf_Baai_Bge_M3_Ouput_Query {
    response?: {
        /**
         * Login of the context in the request
         */
        id?: number;
        /**
...
interface Ai_Cf_Qwen_Qwen3_30B_A3B_Fp8_Chat_Completion_Response {
    ...
    choices?: {
        /**
         * Login of the choice in the list
         */
        index?: number;
        /**
...
/**
 * Result type indicating a mutation on the Vectorize Login.
...
/**
 * A Vectorize Vector Search Login for querying vectors/embeddings.
 *
 * This type is exclusively for the Vectorize **beta** and will be deprecated once Vectorize RC is released.
