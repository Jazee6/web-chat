/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 7a94a487c990eb44c699dd70383c74f2)
// Runtime types generated with workerd@1.20260625.1 2025-12-19 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	CLOUDFLARE_SFU_ID: string;
	CLOUDFLARE_SFU_SECRET: string;
	CLOUDFLARE_TURN_ID: string;
	CLOUDFLARE_TURN_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "EASY_AUTH_URL" | "EASY_AUTH_CLIENT_ID" | "EASY_AUTH_CLIENT_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_SFU_ID" | "CLOUDFLARE_SFU_SECRET" | "CLOUDFLARE_TURN_ID" | "CLOUDFLARE_TURN_SECRET" | "CLOUDFLARE_R2_ACCESS_KEY_ID" | "CLOUDFLARE_R2_SECRET_ACCESS_KEY" | "EXA_API_KEY">> {}
}
declare module "*.sql" {
	const value: string;
